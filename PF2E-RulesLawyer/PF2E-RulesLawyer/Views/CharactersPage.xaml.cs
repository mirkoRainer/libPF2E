...
namespace PF2E_RulesLawyer.Views
{
    ...
    public partial class CharactersPage : ContentPage
    {
        ...
        private async void OnCharacterSelected(object sender, SelectedItemChangedEventArgs args)
        {
            ...
            await Navigation.PushAsync(new PlayerCharacterSheetPage(new PlayerCharacterSheetViewModel(character)));
        ...
        {
            await Navigation.PushModalAsync(new NavigationPage(new PlayerCharacterSheetPage(new PlayerCharacterSheetViewModel())));
        }
